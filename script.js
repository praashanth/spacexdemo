    ...
    .then(data => {
        ...
        data.map(mission =>{
            let htmlData = `<div class="card">
                                ...
                                <div class="data">
                                    <span class="name tittlecolor"><b> ${mission.mission_name} #${mission.flight_number}</b></span>
                                    <span><b>Mission Ids :</b>
									<span class="mission_color">
									${mission.mission_id.join(', ')}
									</span>
									</span>
                                    <span class="year"><b>Launch Year:</b>
									<span class="mission_color">
									${mission.launch_year}</span></span>
                                    <span><b>Successful Launch:</b>
									<span class="mission_color">
									${mission.launch_success}</span></span>
                                    <span><b>Successful Landing:</b>
									<span class="mission_color">${mission.rocket.first_stage.cores[0].land_success}</span>
									</span>
                                </div>
                            </div>`
